...
return new class extends Migration
{
    ...
    {
        Schema::create('stock_dispatches', function (Blueprint $table): void {
            $table->id();
            ...
            $table->foreignId('dispatched_by_user_id')->constrained('users')->cascadeOnUpdate()->restrictOnDelete();
            $table->date('dispatch_date');
            $table->string('status')->default('draft');
            $table->foreignId('accepted_by_user_id')->nullable()->constrained('users')->cascadeOnUpdate()->restrictOnDelete();
