 ...
 * create, view (scoped to their territory — see DemandCreator's ScopesToTerritory),
 * and edit rows they created, via the field panel. The superuser role is granted
...
class DemandCreatorPolicy
{
    ...
    public function update(User $user, DemandCreator $demandCreator): bool
    {
        ...
        return $user->hasRole('sales_rep') && $demandCreator->created_by === $user->id;
    }
