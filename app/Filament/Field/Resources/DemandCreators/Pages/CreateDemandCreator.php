...
class CreateDemandCreator extends CreateRecord
{
     ...
     * mass-assignable ({@see DemandCreator}), so it is set on the instance
    ...
    private function resolveActivePosition(int|string|null $positionId): Position
    {
        ...
        if (! $position instanceof Position) {
            Notification::make()
                ...
                ->body('You need an active position before you can add a demand creator.')
                ->send();
