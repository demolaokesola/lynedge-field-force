...
namespace App\Filament\Field\Resources\DemandCreators\Schemas;
        ...
        return $schema
            ->components([
                Select::make('position_id')
                    ...
                    ->required()
                    ->native(false)
                    // DemandCreator has no position_id column — it only exists here to
                    // derive territory_id at create time (see CreateDemandCreator).
                    // Territory is fixed afterwards, so there is nothing to edit.
                    ->hiddenOn('edit'),
